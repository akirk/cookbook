    ...
    <div
        ...
        data-strings="<?php
            echo esc_attr(
                wp_json_encode(
                    array(
                        'sectionTitle'              => __( 'Section title (optional)', 'cookbook' ),
                        'ingredientSectionTitle'    => __( 'Section header', 'cookbook' ),
                        'mergeIngredientSection'    => __( 'Remove section header and merge ingredients', 'cookbook' ),
                        'mergeInstructionSection'   => __( 'Remove section header and merge steps', 'cookbook' ),
                        'two'                       => __( '2', 'cookbook' ),
                        'gram'                      => __( 'g', 'cookbook' ),
                        'ingredient'                => __( 'ingredient', 'cookbook' ),
                        'chopped'                   => __( 'chopped', 'cookbook' ),
                        'remove'                    => __( 'Remove', 'cookbook' ),
...
wp_app_enqueue_script(
    'cookbook-form',
    plugins_url( 'assets/cookbook-form.js', dirname( __DIR__ ) . '/cookbook.php' ),
    array(),
